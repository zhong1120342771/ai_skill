...
**If the text is Chinese (中文), read [references/chinese-ai-tells.md](references/chinese-ai-tells.md) first.** The English examples below (em dash, curly quotes, title case) only partly apply to Chinese; the Chinese tells (值得注意的是 / 综上所述 / 不仅…而且 / 赋能·抓手·闭环, etc.) live in that file.
